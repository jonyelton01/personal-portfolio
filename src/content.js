...
export const moment = {
  ...
  photos: [
    ...
    {
      src: asset("gallery/comedy-studies.jpg"),
    ...
    {
      src: asset("gallery/butterdolphin.jpg"),
    ...
    {
      src: asset("gallery/sc-conservatory.jpg"),
    ...
    {
      src: asset("gallery/ph-productions.jpg"),
...
export const table = {
  ...
  flyer: {
    src: asset("gallery/aoa-full.jpg"),
...
export const artifact = {
  ...
  image: asset("louisville-theatre.jpg"),
}
